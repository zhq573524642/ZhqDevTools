 ...
 * <p>
 * 下载于 https://github.com/Shinelw/ColorArcProgressBar   by:yaodetao
 */
public class ColorArcProgressBar extends View {
    ...
    private int[] colors = new int[]{Color.GREEN, Color.YELLOW, Color.YELLOW, Color.RED};
     ...
     * 外面长条的刻度
     */
    private String longDegreeColor = "#999999";
    /**
     * 外面短条的刻度
     */
    private String shortDegreeColor = "#999999";
    /**
     * 进度圆弧底色
     */
    ...
    private void initCofig(Context context, AttributeSet attrs) {
        ...
        hintColor = a.getColor(R.styleable.ColorArcProgressBar_hint_color, getResources().getColor(R.color.color_676767));
//        colors = new int[]{color1, color1, color2, color3, Color.MAGENTA};
//        colors = new int[]{color1, color1, color2, color3, color3};
//        colors = new int[]{color2, color1, color1, color2, color3, color3};
        colors = new int[]{color2, color1, color1, color2, color3, color4, color4};
        backColor = a.getColor(R.styleable.ColorArcProgressBar_back_color, color1);
    ...
    private void initView() {
        ...
        degreePaint.setColor(Color.parseColor(longDegreeColor)); // 外面长条的刻度
        ...
        allArcPaint.setColor(Color.parseColor(bgArcColor));  // 圆弧
...
//        vTextPaint.setColor(Color.BLACK); // 原来的背景色
        vTextPaint.setColor(backColor);
        ...
        if (isNeedDial) {
            ...
            for (int i = 0; i < 40; i++) {
                ...
                if (i % 5 == 0) {
                    ...
                    degreePaint.setColor(Color.parseColor(shortDegreeColor));  // 外面短条的刻度
     ...
     * @param aniSpeed      动画时间
     */
    public void setCurrentValues(float currentValues, int aniSpeed) {
        if (currentValues > maxValues) {
            currentValues = maxValues;
        }
        if (currentValues < 0) {
    ...
    public void setBackColor(@ColorInt int backColor) {
        vTextPaint.setColor(backColor);
//        vTextPaint.setColor(Color.parseColor("#ff0000"));
    }
